...
```{r}
# Your code here: 
some_dates <- c(04221978, 03262020, 06171995) # Creates a vector of dates w/o spaces
some_dates_converted <- mdy(my_dates) # Converts to Date, stores as my_dates_converted
some_dates_converted # Return my_dates_converted
